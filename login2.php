	...
	<div id="wrap-content-inner">
		...
		<div class="box clear">
			...
			<div class="box-content">
				<? print $message; ?>
				<object type="application/x-shockwave-flash" data="/_flash/login.swf?inst=<? print $institution->getId(); ?>" width="800" height="600">
				<param name="movie" value="/_flash/login.swf?inst=<? print $institution->getId(); ?>" />
				</object>
			</div>
		</div><!-- /.box -->
