...
class User extends DatabaseObject
{
	...
	public function HtmlUserDetails(SimplePage $page, Theme $theme, $edit=false)
	{
		...
		$changeImgLink = Link::CreateIconLink('Change picture', $changeImgPath, $theme->Icon('change-picture', 'Change picture'), array('alt' => 'Change picture'));
		...
		if(!$edit) {
			...
			$changeTextLink = Link::CreateIconLink('Change description', $changeTextPath, $theme->Icon('edit', 'Change description'), array('alt' => 'Change description'));
