...
class User extends DatabaseObject
{
	...
	public function HtmlExportProfileForm()
	{
		...
		if(file_exists($profileExportFile))
		{
			...
			$html .= '<p>This is an existing export:</p>';
			$html .= "<ul><li><a href=\"/export/{$this->getId()}/\">Download last export zip file</a> &ndash; " . Date::formatLongForScreen($fileTime) . "</li></ul>";
		}
	...
	public function HtmlUserDetails(SimplePage $page, Theme $theme, $edit=false)
	{
		...
		$changeImgLink = Link::CreateIconLink('Change picture', $changeImgPath, $theme->Icon('change-picture', 'Change picture'));
		...
		if(!$edit) {
			...
			$changeTextLink = Link::CreateIconLink('Change description', $changeTextPath, $theme->Icon('edit', 'Change description'));
